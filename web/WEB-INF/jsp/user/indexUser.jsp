...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
            <li class="nav-item"><a class="nav-link" href="userRedact">Профиль</a></li>
            <li class="nav-item"><a class="nav-link" href="takenTestsView">Пройденные тесты</a></li>
...
<table class="table">
    ...
    <c:forEach items="${requestScope.testInfos}" var="testInfo">
        <tr>
            ...
            <td>
                <a href="testInfo?testInfoId=${testInfo.getId()}" class="badge badge-light">Подробнее</a>
            </td>
        </tr>
    </c:forEach>
    </tbody>

...
@WebServlet(name = "TryToRedactTestInfoController", urlPatterns = "/tryToRedactTestInfo")
public class TryToRedactTestInfoController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        if (validate(request)) {
            ...
            testInfo.setName(request.getParameter("name"))
            ...
            service.updateTestInfo(testInfo, testInfo.getId());
            response.sendRedirect("adminIndex");
        } else {
            response.sendRedirect("testRedact");
        }
    }
